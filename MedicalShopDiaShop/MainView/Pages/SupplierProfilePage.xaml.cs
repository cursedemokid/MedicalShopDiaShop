...
{
    public partial class SupplierProfilePage : Page, INotifyPropertyChanged
    {
        ...
        public SupplierProfilePage(int supplierId)
        {
            InitializeComponent();
            _supplierId = supplierId;
            DataContext = this;
            Loaded += SupplierProfilePage_Loaded;
        }

        private void SupplierProfilePage_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            LoadSupplierInfo();
